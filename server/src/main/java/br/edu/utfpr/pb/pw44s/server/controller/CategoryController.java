...
import br.edu.utfpr.pb.pw44s.server.dto.response.CategoryResponseDTO;
...
public class CategoryController extends CrudController<Category, CategoryDTO, CategoryResponseDTO, Long> {
    ...
    public CategoryController(ICategoryServiceWrite categoryServiceWrite, ICategoryServiceRead categoryServiceRead, ModelMapper modelMapper) {
        super(Category.class, CategoryDTO.class, CategoryResponseDTO.class);
